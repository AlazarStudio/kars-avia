...
export const FACILITY_ITEMS = [
  ...
  item("bar", "Бар / лобби-бар", "лобби-бар", ["бар", "лобби бар"]),
  ...
  item("spa", "СПА", "спа", ["spa", "спа-центр"]),
  ...
  item("cooler", "Кулер на этажах", "кулер на этажах", ["кулер на этаже", "кулер", "кулер с водой"]),
...
export const ROOM_GROUPS = [
  {
    ...
    items: [
      ...
      item("wardrobe", "Шкаф", "шкаф", ["шкаф для одежды", "гардероб", "платяной шкаф"]),
      item("nightstands", "Прикроватные тумбы", "прикроватные тумбы", ["прикроватные тумбочки", "прикроватная тумба", "тумбочки", "тумбочка", "тумбы"]),
  ...
  },
  {
    ...
    items: [
      ...
      item("tv", "Телевизор", "телевизор", ["тв", "телевизор с плоским экраном", "жк-телевизор", "спутниковое телевидение", "кабельное телевидение"]),
  ...
  },
  {
    ...
    items: [
      ...
      item("towels", "Полотенца", "полотенца", ["банные полотенца"]),
      item("bathrobes", "Халаты", "халаты", ["халат"]),
      item("slippers", "Тапочки", "тапочки", ["тапки"]),
      item("toiletries", "Гигиенические принадлежности", "гигиенические принадлежности", ["косметические принадлежности", "туалетные принадлежности", "средства гигиены"]),
    ],
  },
  {
    title: "Прочее",
    items: [
      item("teaSet", "Чайный набор", "чайный набор", ["принадлежности для чая и кофе", "набор для чая"]),
      item("water", "Питьевая вода", "бутилированная вода", ["питьевая вода"]),
      item("linen", "Постельное бельё", "постельное бельё"),
      item("blackout", "Шторы блэкаут", "шторы блэкаут", ["шторы black-out", "шторы blackout", "шторы блэк-аут"]),
      item("lamps", "Светильники", "светильники", ["светильник"]),
    ],
  },
];
