...
// Отметки в колонке «РМ»: пассажиры, у которых нет своих строк в файле.
// Что означает «РМ», в самом манифесте не расшифровано. Косвенно это младенцы на
// руках: итоговая строка даёт «Пассажиры: 78 / 13 / 3», первые два числа точно
// совпадают с ADT и CHD из колонки «Кат» (91 строка), а третье не имеет ни одной
// строки — и ровно столько же отметок в «РМ»; плюс в формате PNL «РМ» это младенец.
// Вывод косвенный, поэтому наружу отдаём факт, а не категорию: количество и ФИО тех,
// у кого колонка заполнена. Безымянные записи в каталог не заводим.
