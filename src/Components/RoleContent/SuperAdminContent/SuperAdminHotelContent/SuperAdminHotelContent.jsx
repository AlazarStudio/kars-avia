...
import classes from './SuperAdminHotelContent.module.css'

const SuperAdminHotelContent = ({ id, user, selectedTab, handleTabSelect }) => (
	<Tabs
...
export default SuperAdminHotelContent
