...
const ConfirmBookingModalV2 = ({ isOpen, onClose, onConfirm, request }) => {
  return (
    <Dialog open={isOpen} onClose={onClose} disableScrollLock={true}>
      ...
      <DialogContent>
        <Typography variant="body1">
          ...
          <b>{request?.guest}</b> с {convertToDate(request?.checkInDate)} по{" "}
...
export default ConfirmBookingModalV2;
