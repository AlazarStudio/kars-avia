...
Для обоих типов:
- Эскадрилья (доступ, создание, чат, редактирование; отдельно - редактирование заявки в архиве)
...
- Аналитика (эскадрилья, пассажиры; выгрузка - только для авиакомпаний)
...
Структура строки уведомления (слева направо):
1. **Текст** — название типа уведомления
2. **MUISwitch** — переключатель (выровнен в единую колонку по всем строкам)
3. **Чекбокс «на почту»** — уведомление на email
4. **Чекбокс «в браузере»** — уведомление в браузере
