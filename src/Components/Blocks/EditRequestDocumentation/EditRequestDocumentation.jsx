...
import classes from "./EditRequestDocumentation.module.css";
...
function EditRequestDocumentation({
  show,
  onClose,
...
export default EditRequestDocumentation;
