...
import classes from "./InfoTableDataReserveRepresentative.module.css";
...
function InfoTableDataReserveRepresentative({
  placement,
  allHotelPlacement,
  setPlacement,
  toggleUpdateSidebar,
...
export default InfoTableDataReserveRepresentative;
