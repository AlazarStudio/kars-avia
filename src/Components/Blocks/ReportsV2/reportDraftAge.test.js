...
test("порог не оставлен заниженным после проверки на стенде", () => {
  // Остальные тесты считают даты от самой константы и потому зелены при
  // любом её значении. Эта проверка ловит невозвращённую правку, которой
  // диалог устаревания доводят до срабатывания вручную. Если порог меняют
  // осознанно как продуктовое решение — это число в тесте правится вместе
  // с константой, а не наоборот.
